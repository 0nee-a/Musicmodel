...
writefile("OG Main Theme Song.mp3", game:HttpGet("https://github.com/0nee-a/Musicmodel/raw/refs/heads/main/OG%20Main%20Theme%20Song.mp3"))
...
function Callback(answer)
 ...
 local Sound = Instance.new("Sound")
        ...
        Sound.SoundId = getcustomasset("OG Main Theme Song.mp3")
        Sound.Volume = 1.5
        Sound.Looped = true
        Sound:Play()
        
    
-- https://scriptblox.com/script/Waterpark-Old-Animations-7547
